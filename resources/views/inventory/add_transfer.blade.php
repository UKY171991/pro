            ...
            <div class="col-12">
               <div class="card">
                        ...
                        <div class="row">
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <input type="date" class="form-control  datepicker" id="transfer_date" name="transfer_date" value="15-04-2023">
                                 <span id="err_transfer_date" class="error invalid-feedback"></span>
                              </div>
                           </div>
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <select class="form-control form-control-sm" name="from_warehouse_id" id="from_warehouse_id">
                           ...
                           <div class="col-sm-4">
                              <div class="form-group">
                                 ...
                                 <select class="form-control form-control-sm" name="to_warehouse_id" id="to_warehouse_id">
                  ...
                  <div class="card-footer">
                     ...
                     <button type="submit" name="submit" id="saleSubmit" class="btn btn-info">Add Transfer</button>
                  </div>
               </div>
               <!-- /.card -->
            </div>
