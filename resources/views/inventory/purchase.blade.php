                  ...
                  <div class="card-header">
                     ...
                     <div class="card-tools">
                        <ul class="nav nav-pills ml-auto">
                           <li class="nav-item">
                              <a class="nav-link btn-sm active" href="{{url('/add-purchase')}}" data-tt="tooltip" title="" data-original-title="Click here to Add Transfer"><i class="far fa-snowflake mr-2"></i>Add Purchase</a>
                           </li>
                        </ul>
                     </div>
                  </div>
                     ...
                     <table id="example" class="table table-bordered table-striped">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td class="btn-group">
                    			<a href="{{url('/view-purchase/1')}}"class="btn btn-default btn-xs" data-tt="tooltip" data-original-title="View purchase"><i class="fas fa-eye"></i> View</a>
                    			<a href="{{url('/edit-purchase/1')}}" class="btn btn-info btn-xs" data-tt="tooltip" data-original-title="Edit purchase"><i class="fas fa-edit"></i> Edit</a>
