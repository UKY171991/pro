            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-header">
                     <h3 class="card-title">View Sales Return</h3>
                     <div class="card-tools">
                        ...
                        <a href="{{url('/edit-sales-return/1')}}" class="btn btn-info btn-sm" data-tt="tooltip" title="" data-original-title="Edit Purchase">
